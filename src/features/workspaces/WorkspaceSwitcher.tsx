                  ...
                  <button
                    onClick={async () => {
                      const ok = await confirm({
                        ...
                        body:
                          "Its collection, environments, mock routes, monitors and comments are deleted.",
                        warning:
                          "This cannot be undone, and peers syncing this workspace lose it too.",
                        confirmLabel: "Delete workspace",
                        danger: true,
                      });
                      if (ok) guard(remove(workspace.id));
                    }}
